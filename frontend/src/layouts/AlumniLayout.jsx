// frontend/src/layouts/AlumniLayout.jsx
...
import {
    ...
    GraduationCap, Users, UserCircle, Menu
} from 'lucide-react';

const navItems = [
    { to: '/alumni/dashboard', icon: LayoutDashboard, label: 'Dashboard' },
    { to: '/alumni/network', icon: Users, label: 'Student Directory' },
    { to: '/alumni/messages', icon: MessageSquare, label: 'Messages' },
    { to: '/alumni/profile', icon: UserCircle, label: 'Profile' },
];
            ...
            <div className="p-6 border-b border-[var(--border-main)] shrink-0">
                <div className="flex items-center gap-2">
                    ...
                    <h1 className="text-xl font-black tracking-tighter text-[var(--text-main)] uppercase italic">
                        SPIMS<span className="text-cyan-500">+</span>
                    </h1>
                </div>
            </div>
                    ...
                    <Link
                        ...
                        className={`flex items-center gap-3 p-3 rounded-xl transition-all font-bold group
                            ${isActive(to)
                                ...
                                : 'text-[var(--text-muted)] hover:bg-cyan-600/10 hover:text-cyan-400'
                            }`}
                    >
                        <Icon
                            size={20}
                            className={isActive(to) ? 'text-white' : 'text-slate-400 group-hover:text-cyan-400'}
                        />
                        {label}
                    </Link>
                ))}
            ...
            <div className="flex-1 flex flex-col overflow-hidden min-w-0">
                ...
                <header className="h-16 bg-[var(--bg-card)]/80 backdrop-blur-md border-b border-[var(--border-main)] px-4 md:px-8 flex items-center justify-between z-50 shrink-0">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xs md:text-sm font-black text-cyan-400 uppercase tracking-widest">
                                Alumni Legacy Portal
                            </h2>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="w-8 h-8 rounded-full bg-cyan-600 border border-cyan-500/40 flex items-center justify-center">
