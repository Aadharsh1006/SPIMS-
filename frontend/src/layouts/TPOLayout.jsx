// frontend/src/layouts/TPOLayout.jsx
...
import {
    LogOut, LayoutDashboard, BarChart3, Briefcase, UserPlus,
    Users, GraduationCap, MessageSquare, Settings, Menu, TrendingUp, UserCheck
} from 'lucide-react';

const navItems = [
    { to: '/tpo/dashboard', icon: LayoutDashboard, label: 'Dashboard' },
    { to: '/tpo/analytics', icon: BarChart3, label: 'Analytics' },
    { to: '/tpo/jobs', icon: Briefcase, label: 'Manage Jobs' },
    { to: '/tpo/job-market', icon: TrendingUp, label: 'Job Market' },
    { to: '/tpo/onboarding', icon: UserPlus, label: 'Onboarding' },
    { to: '/tpo/students', icon: Users, label: 'Students' },
    { to: '/tpo/faculties', icon: UserCheck, label: 'Faculties' },
    { to: '/tpo/alumni', icon: GraduationCap, label: 'Alumni' },
    { to: '/tpo/messages', icon: MessageSquare, label: 'Messages' },
    { to: '/tpo/settings', icon: Settings, label: 'Portal Settings' },
];
