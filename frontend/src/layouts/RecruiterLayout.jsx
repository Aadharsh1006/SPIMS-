// frontend/src/layouts/RecruiterLayout.jsx
...
import {
    LogOut, LayoutDashboard, Briefcase, Users, MessageSquare,
    Building2, UserCircle, ShieldCheck, FileText, GraduationCap, Menu, User
} from 'lucide-react';

const navItems = [
    { to: '/recruiter/dashboard', icon: LayoutDashboard, label: 'Dashboard' },
    { to: '/recruiter/jobs', icon: Briefcase, label: 'My Jobs' },
    { to: '/recruiter/requests', icon: ShieldCheck, label: 'Access Requests' },
    { to: '/recruiter/applications', icon: FileText, label: 'Applicants' },
            ...
            <div className="p-6 border-b border-[var(--border-main)] shrink-0">
                <div className="flex items-center gap-2">
                    ...
                    <h1 className="text-xl font-black tracking-tighter text-[var(--text-main)] uppercase italic">
                        SPIMS<span className="text-emerald-500">+</span>
                    </h1>
                </div>
            </div>
                    ...
                    <Link
                        ...
                        className={`flex items-center gap-3 p-3 rounded-xl transition-all font-bold group
                            ${isActive(to)
                                ...
                                : 'text-[var(--text-muted)] hover:bg-emerald-600/10 hover:text-emerald-400'
                            }`}
                    >
                        <Icon
                            size={20}
                            className={isActive(to) ? 'text-white' : 'text-slate-400 group-hover:text-emerald-400'}
                        />
                        {label}
                    </Link>
                ))}
            ...
            <div className="flex-1 flex flex-col overflow-hidden min-w-0">
                ...
                <header className="h-16 bg-[var(--bg-card)]/80 backdrop-blur-md border-b border-[var(--border-main)] px-4 md:px-8 flex items-center justify-between z-50 shrink-0">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xs md:text-sm font-black text-emerald-400 uppercase tracking-widest">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="w-8 h-8 rounded-full bg-emerald-600 border border-emerald-500/40 flex items-center justify-center">
